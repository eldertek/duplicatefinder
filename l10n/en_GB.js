OC.L10N.register(
    ...
    "Sort: Size (largest first)" : "Sort: Size (largest first)",
    "Sort: Size (smallest first)" : "Sort: Size (smallest first)",
    "Sort: Default" : "Sort: Default",
    "Are you sure you want to delete all selected duplicates? This action cannot be undone." : "Are you sure you want to delete all selected duplicates? This action cannot be undone.",
    ...
    "Bulk delete duplicates" : "Bulk delete duplicates",
    "Preview and delete multiple duplicates at once while preserving files in protected folders." : "Preview and delete multiple duplicates at once while preserving files in protected folders.",
    ...
    "Select all except first file of each group" : "Select all except first file of each group",
    "Select all except last file of each group" : "Select all except last file of each group",
    ...
    "Files in origin folders are automatically protected and will not be deleted." : "Files in origin folders are automatically protected and will not be deleted.",
    "Duplicate group" : "Duplicate group",
    "{selected} of {total} files selected" : "{selected} of {total} files selected",
    "{count} protected files in origin folders" : "{count} protected files in origin folders",
    "Duplicate group (all files protected)" : "Duplicate group (all files protected)",
    "All {count} files are in origin folders and cannot be deleted" : "All {count} files are in origin folders and cannot be deleted",
    "Preview" : "Preview",
    ...
    "Organize cleanup tasks by creating separate projects for different areas" : "Organise cleanup tasks by creating separate projects for different areas",
    ...
    "Mark duplicates as acknowledged for better organization" : "Mark duplicates as acknowledged for better organisation",
    ...
    "Mark duplicates as acknowledged to organize them better" : "Mark duplicates as acknowledged to organise them better",
    ...
    "Project scan initiated" : "Project scan initiated",
    "Failed to initiate project scan" : "Failed to initiate project scan",
