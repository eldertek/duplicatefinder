OC.L10N.register(
    ...
    "Path:" : "Path:",
    "Delete" : "Delete",
    "Fetching duplicates" : "Fetching duplicates",
    "No duplicates found or no duplicate selected." : "No duplicates found or no duplicate selected.",
    "Could not fetch duplicates" : "Could not fetch duplicates",
    "Duplicate acknowledged successfully" : "Duplicate acknowledged successfully",
    "Could not acknowledge the duplicate" : "Could not acknowledge the duplicate",
    "Duplicate unacknowledged successfully" : "Duplicate unacknowledged successfully",
    "Could not unacknowledge the duplicate" : "Could not unacknowledge the duplicate",
    "Duplicate deleted" : "Duplicate deleted",
    "Could not fetch ${type} duplicates" : "Could not fetch ${type} duplicates",
    "Could not delete the duplicate at path: ${item.path}" : "Could not delete the duplicate at path: ${item.path}",
