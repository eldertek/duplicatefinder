OC.L10N.register(
    ...
    "Could not fetch duplicates" : "Не удалось получить дубликаты",
    "Duplicate acknowledged successfully" : "Дубликат успешно признан",
    "Could not acknowledge the duplicate" : "Не удалось признать дубликат",
    "Duplicate unacknowledged successfully" : "Дубликат успешно не признан",
    "Could not unacknowledge the duplicate" : "Не удалось признать дубликат",
    "Duplicate deleted" : "Дубликат удалён",
    "Could not delete the duplicate at path: ${item.path}" : "Не удалось удалить дубликат по пути: ${item.path}",
