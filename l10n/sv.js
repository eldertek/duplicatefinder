OC.L10N.register(
    ...
    "Could not fetch duplicates" : "Det gick inte att hämta dubbletter",
    "Duplicate deleted" : "Dublett raderad",
    "Could not delete the duplicate at path: ${item.path}" : "Det gick inte att ta bort dubbletten med sökvägen: ${item.path}",
