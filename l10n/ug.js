OC.L10N.register(
    ...
    "Welcome, the current duplicate has {numberOfFiles} files, total size: {formattedSize}" : "خۇش كەپسىز ، نۆۋەتتىكى كۆپەيتىلگەن نۇسخىدا {numberOfFiles} ھۆججىتى بار ، ئومۇمىي چوڭلۇقى: {formatSize}",
