OC.L10N.register(
    ...
    "FAQ" : "FAQ",
    "Help" : "Aide",
    "Could not load duplicates" : "Não foi possivel carregar duplicados",
    ...
    "Failed to load duplicates" : "Échec du chargement des doublons",
    "Project scan initiated. This may take a while." : "Lancement de l'analyse du projet. Cela peut prendre un certain temps.",
    "Project" : "Projet",
    "Last scan: {date}" : "Dernier scan : {date}",
    "Never scanned" : "Jamais scanné",
    "{count} folders included" : "{count} dossiers inclus",
    "Scan for Duplicates" : "Recherche de doublons",
    "Duplicates Found" : "Doublons trouvés",
    "{count} duplicate files" : "{count} fichiers en doublons",
    "View Details" : "Voir les détails",
    "and {count} more files..." : "et {count} fichiers de plus...",
    "No duplicate files were found in the selected folders." : "Aucun fichier en double n'a été trouvé dans les dossiers sélectionnés.",
    ...
    "View project results" : "Voir les résultats du projet",
    "View Results" : "Afficher les résultats",
    "Included Folders:" : "Dossier inclus :",
    ...
    "Creating a Project" : "Création d'un nouveau projet en cours",
